...
export default function HomeTugas6() {
  const router = useRouter();
  const lastBook = ListBook[ListBook.length - 1];
  const [search, setSearch] = useState("");
  const filteredBooks = getFilteredBooks(search);

  // Custom CTABook yang menavigasi ke router.push(/module_tugas/tugas6/books/...)
        ...
        <View style={{ flexDirection: "row" }}>
          ...
          >
            ...
            <TouchableOpacity 
              ...
              onPress={() => router.push(`/module_tugas/tugas6/books/${book.id}`)}
            >
  ...
  // Custom Book collections grid yang menavigasi ke detail
