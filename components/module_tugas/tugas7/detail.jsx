...
export default function BookDetailAudio() {
  ...
  // Bersihkan audio speech jika berpindah halaman
  useEffect(() => {
    return () => {
      Speech.stop();
    };
  ...
  const handlePlay = () => {
    if (isPaused) {
      ...
      // Baca sinopsis dan isi cerita buku
      ...
      Speech.speak(textToRead, {
        language: "en-US", // Membaca dalam bahasa Inggris karena konten buku testing berbahasa inggris
        pitch: 1.0,
        rate: 0.9,
        onDone: () => {
          setIsPlaying(false);
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            ...
            if (router.canGoBack()) {
              ...
              router.push("/module_tugas/tugas7");
            }
          }}
        >
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#111827", // Dark layout
  },
  headerControls: {
    flexDirection: "row",
